...
const CASE_STUDIES = {
  ...
  "civic-platform": {
    ...
    results: [
      { n: "167",   u: "days", label: "Staff time saved",             desc: "In the first two weeks post launch 8,000 copies of just one form type were generated. Saving 167 days of work.", note: "Source: platform analytics, first two weeks post-launch" },
