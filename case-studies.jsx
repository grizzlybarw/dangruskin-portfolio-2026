        ...
        <div className="shell">
          ...
          {!data.confidential || data.heroImage
            ? <div className={"cs-hero-frame" + (data.heroImage ? " cs-hero-frame--photo" : "")} ref={schemaRef}>
                ...
                {data.heroImage
                  ? <img src={data.heroImage} alt={data.title.join(" ")} className="cs-hero-img" style={data.heroImagePosition ? { objectPosition: data.heroImagePosition } : {}} />
                  : <Schema />}
              </div>
            : null}
        </div>
