...
const CASE_STUDIES = {
  "supervisor-review": {
    ...
    meta: [
      ...
      { label: "Team", value: "Designer \xB7 PM \xB7 Eng \xB7 Stakeholders" },
      { label: "Timeline", value: "4 months" },
      { label: "Domain", value: "Civic Tech \xB7 Enterprise UX" }
    ],
    Schema: SchemaSupervisor,
    workflow: {
      before: {
        label: "Before \xB7 Acrobat",
        steps: [
        ...
        tools: "Acrobat \xB7 Local files \xB7 Email",
        summary: "5 steps \xB7 3 tools \xB7 fully off-platform"
      },
      after: {
        label: "After \xB7 Review mode",
        steps: [
        ...
        tools: "Platform only",
        summary: "3 steps \xB7 1 tool \xB7 no downloads, no email"
      }
    },
    schemaAnnotations: [
    ...
    next: { slug: "interview-platform", title: "Interview Platform Redesign", tags: "UX Design \xB7 Enterprise UX \xB7 Civic Tech" }
  },
  "interview-platform": {
    ...
    meta: [
      ...
      { label: "Team", value: "Design \xB7 Eng \xB7 Leadership \xB7 Stakeholders" },
    ...
    workflow: {
      ...
      after: {
        ...
        summary: "Reduced cognitive load \xB7 97% positive feedback"
      }
    },
    schemaAnnotations: [
    ...
    next: { slug: "case-finder", title: "Case Finder", tags: "Product Design \xB7 Civic Tech \xB7 Information Architecture" }
  },
  "civic-platform": {
    ...
    meta: [
      { label: "Role", value: "Senior Product Designer" },
      { label: "Team", value: "Design \xB7 PM \xB7 Eng \xB7 Stakeholders" },
    ...
    next: { slug: "gridx-empower", title: "GridX Empower, re-imagined", tags: "SaaS \xB7 Product Strategy \xB7 Clean Energy" }
  },
  "case-finder": {
    ...
    meta: [
      ...
      { label: "Domain", value: "Civic Tech \xB7 Information Architecture" }
    ],
    Schema: SchemaInterview,
    workflow: {
      before: {
        label: "Before \xB7 Personal systems",
        steps: [
        ...
        tools: "Local folders \xB7 Personal notes \xB7 Shared drives",
        summary: "4+ steps \xB7 every officer had a different system"
      },
      after: {
        label: "After \xB7 Case Finder",
        steps: [
        ...
        tools: "Platform only",
        summary: "3 steps \xB7 1 tool \xB7 ~40% faster case lookup"
      }
    },
    schemaAnnotations: [
  ...
  "gridx-empower": {
    ...
    meta: [
      ...
      { label: "Team", value: "Design \xB7 Product \xB7 Eng \xB7 Execs" },
      { label: "Type", value: "Vision / Strategy" },
      { label: "Domain", value: "Clean Energy \xB7 SaaS" }
    ],
    ...
    next: { slug: "gridx-touchscreen", title: "GridX Interactive Touchscreen Demo", tags: "Interactive \xB7 Sales Enablement \xB7 Clean Energy" }
  },
  "gridx-touchscreen": {
    ...
    meta: [
      ...
      { label: "Team", value: "Design \xB7 Marketing \xB7 Sales \xB7 Eng" },
    ...
    next: { slug: "taylor-series", title: "Taylor Guitars Series Pages", tags: "E-commerce \xB7 Content Design \xB7 Consumer Brand" }
  },
  "taylor-series": {
    ...
    meta: [
      ...
      { label: "Team", value: "Web Mgr \xB7 Mktg Dir \xB7 Agency \xB7 Internal media" },
      { label: "Client", value: "Taylor Guitars" },
      { label: "Domain", value: "E-commerce \xB7 Content Design" }
    ],
    ...
    next: { slug: "taylor-sustainability", title: "Taylor Sustainability Hub", tags: "Editorial Design \xB7 Brand \xB7 Consumer" }
  },
  "taylor-sustainability": {
    ...
    meta: [
      ...
      { label: "Team", value: "Web Mgr \xB7 Agency Partners \xB7 Content Team" },
      { label: "Company", value: "Taylor Guitars" },
      { label: "Domain", value: "Editorial Design \xB7 Brand" }
    ],
    ...
    next: { slug: "supervisor-review", title: "Supervisor Review Mode", tags: "Workflow Design \xB7 Enterprise UX \xB7 Civic Tech" }
  }
};
function Lightbox({ screens, index, onClose, onPrev, onNext }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "cs-lightbox", onClick: onClose }, /* @__PURE__ */ React.createElement("button", { className: "cs-lightbox-close", onClick: onClose, "aria-label": "Close" }, "\u2715"), multi && /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    "\u2039"
  ), /* @__PURE__ */ React.createElement("img", { src: screen.image, alt: screen.label, onClick: (e) => e.stopPropagation() }), multi && /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    "\u203A"
  ), multi && /* @__PURE__ */ React.createElement("div", { className: "cs-lightbox-counter" }, index + 1, " ", /* @__PURE__ */ React.createElement("span", null, "/"), " ", screens.length));
}
...
function SchemaFigure({ Schema, annotations = [] }) {
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "schema-figure" }, /* @__PURE__ */ React.createElement(Schema, null), annotations.map((ann, i) => {
    const side = tipSide(ann.lp, ann.tp);
    return /* @__PURE__ */ React.createElement("div", { key: i, className: "schema-ann", style: { left: ann.lp + "%", top: ann.tp + "%" } }, /* @__PURE__ */ React.createElement("button", { className: "schema-ann-dot", "aria-label": "Annotation " + (i + 1) + ": " + ann.note }, i + 1), /* @__PURE__ */ React.createElement("div", { className: "schema-ann-tip schema-ann-tip--" + side, role: "tooltip" }, ann.note));
  })), /* @__PURE__ */ React.createElement("p", { className: "schema-caption" }, "Abstracted system diagram. Not actual UI."));
}
function WorkflowComparison({ workflow }) {
  const { before, after } = workflow;
  return /* @__PURE__ */ React.createElement("div", { className: "wf-compare" }, /* @__PURE__ */ React.createElement("div", { className: "wf-eyebrow" }, "Workflow change"), /* @__PURE__ */ React.createElement("div", { className: "wf-grid" }, /* @__PURE__ */ React.createElement("div", { className: "wf-col wf-before" }, /* @__PURE__ */ React.createElement("div", { className: "wf-col-hd" }, before.label), /* @__PURE__ */ React.createElement("ol", { className: "wf-steps" }, before.steps.map((step, i) => /* @__PURE__ */ React.createElement("li", { key: i, className: "wf-step" }, /* @__PURE__ */ React.createElement("span", { className: "wf-step-num" }, String(i + 1).padStart(2, "0")), /* @__PURE__ */ React.createElement("span", { className: "wf-step-text" }, step)))), /* @__PURE__ */ React.createElement("div", { className: "wf-foot" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "wf-tools-label" }, "Tools: "), before.tools), /* @__PURE__ */ React.createElement("div", null, before.summary))), /* @__PURE__ */ React.createElement("div", { className: "wf-sep", "aria-hidden": "true" }, "\u2192"), /* @__PURE__ */ React.createElement("div", { className: "wf-col wf-after" }, /* @__PURE__ */ React.createElement("div", { className: "wf-col-hd" }, after.label), /* @__PURE__ */ React.createElement("ol", { className: "wf-steps" }, after.steps.map((step, i) => /* @__PURE__ */ React.createElement("li", { key: i, className: "wf-step" }, /* @__PURE__ */ React.createElement("span", { className: "wf-step-num" }, String(i + 1).padStart(2, "0")), /* @__PURE__ */ React.createElement("span", { className: "wf-step-text" }, step)))), /* @__PURE__ */ React.createElement("div", { className: "wf-foot" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "wf-tools-label" }, "Tools: "), after.tools), /* @__PURE__ */ React.createElement("div", null, after.summary)))));
}
function ConfidentialNotice() {
  return /* @__PURE__ */ React.createElement("div", { className: "cs-conf-notice" }, /* @__PURE__ */ React.createElement("div", { className: "cs-conf-badge" }, /* @__PURE__ */ React.createElement("span", { className: "cs-conf-badge-icon", "aria-hidden": "true" }), "Confidential"), /* @__PURE__ */ React.createElement("div", { className: "cs-conf-body" }, /* @__PURE__ */ React.createElement("p", null, "This platform is confidential. No production UI can be shown. What follows is the full decision record: research, architecture, tradeoffs, and measured outcomes."), /* @__PURE__ */ React.createElement("p", null, "I walk approved artifacts through live in interviews.")));
}
function CaseStudy() {
  ...
  if (!data) {
    return /* @__PURE__ */ React.createElement("div", { className: "shell", style: { padding: "180px 0", textAlign: "center" } }, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--sans)", fontWeight: 300, fontSize: 56, marginBottom: 24 } }, "Case study not found."), /* @__PURE__ */ React.createElement("a", { href: "index.html", className: "cs-back" }, "Back to work"));
  }
  const { Schema } = data;
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", { className: "cs-hero" }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("a", { href: "index.html#work", className: "cs-back" }, "All work"), /* @__PURE__ */ React.createElement("div", { className: "cs-eyebrow" }, data.eyebrow.map(
    (e, i) => /* @__PURE__ */ React.createElement(React.Fragment, { key: i }, i > 0 && /* @__PURE__ */ React.createElement("span", { className: "sep" }, "\xB7"), /* @__PURE__ */ React.createElement("span", null, e))
  )), /* @__PURE__ */ React.createElement("h1", { className: "cs-title" }, data.title.map(
    (line, i) => /* @__PURE__ */ React.createElement(React.Fragment, { key: i }, i > 0 && " ", line === data.titleEm ? /* @__PURE__ */ React.createElement("em", null, line) : line)
  )), Array.isArray(data.lede) ? data.lede.map((p, i) => /* @__PURE__ */ React.createElement("p", { key: i, className: "cs-lede" }, p)) : /* @__PURE__ */ React.createElement("p", { className: "cs-lede" }, data.lede), /* @__PURE__ */ React.createElement("div", { className: "cs-meta" }, data.meta.map(
    (m, i) => /* @__PURE__ */ React.createElement("div", { key: i }, /* @__PURE__ */ React.createElement("div", { className: "label" }, m.label), /* @__PURE__ */ React.createElement("div", { className: "value" }, m.value))
  )), data.confidential && /* @__PURE__ */ React.createElement(ConfidentialNotice, null), !data.confidential || data.heroImage ? /* @__PURE__ */ React.createElement("div", { className: "cs-hero-frame" + (data.heroImage ? " cs-hero-frame--photo" : "") + (data.heroContain ? " cs-hero-frame--contain" : "") + (data.heroBorderless ? " cs-hero-frame--borderless" : ""), ref: schemaRef }, /* @__PURE__ */ React.createElement("span", { className: "corner tl" }), /* @__PURE__ */ React.createElement("span", { className: "corner tr" }), /* @__PURE__ */ React.createElement("span", { className: "corner bl" }), /* @__PURE__ */ React.createElement("span", { className: "corner br" }), data.heroImage ? /* @__PURE__ */ React.createElement(
    "img",
    {
      src: data.heroImage,
      alt: data.title.join(" "),
  ...
  ) : /* @__PURE__ */ React.createElement(Schema, null)) : null)), /* @__PURE__ */ React.createElement("section", { className: "cs-section" }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("h2", null, data.problem.heading), /* @__PURE__ */ React.createElement("div", { className: "cs-body" }, /* @__PURE__ */ React.createElement("div", { className: "lhs" }, "The problem"), /* @__PURE__ */ React.createElement("div", { className: "rhs" }, data.problem.body.map((p, i) => /* @__PURE__ */ React.createElement("p", { key: i }, p)))))), /* @__PURE__ */ React.createElement("section", { className: "cs-section cs-section--results" }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("div", { className: "cs-body", style: { marginBottom: 40 } }, /* @__PURE__ */ React.createElement("div", { className: "lhs" }, "Results"), /* @__PURE__ */ React.createElement("div", { className: "rhs" }, data.resultsBlurb && /* @__PURE__ */ React.createElement("p", null, data.resultsBlurb))), /* @__PURE__ */ React.createElement("div", { className: "cs-results" }, data.results.map(
    (r, i) => /* @__PURE__ */ React.createElement("div", { className: "cell", key: i }, /* @__PURE__ */ React.createElement("div", { className: "top" }, r.label), /* @__PURE__ */ React.createElement("div", { className: "stat" }, r.nEm ? r.n.split(r.nEm).map(
      (part, i2, arr) => /* @__PURE__ */ React.createElement(React.Fragment, { key: i2 }, part, i2 < arr.length - 1 && /* @__PURE__ */ React.createElement("span", { className: "mark" }, r.nEm))
    ) : r.n, /* @__PURE__ */ React.createElement("span", { className: "unit" }, r.u)), /* @__PURE__ */ React.createElement("div", { className: "desc" }, r.desc), r.note && /* @__PURE__ */ React.createElement("div", { className: "cs-metric-note" }, r.note))
  )))), data.confidential && (data.workflow || data.schemaAnnotations) && /* @__PURE__ */ React.createElement("section", { className: "cs-design-record" }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("h2", null, "Decision record"), data.workflow && /* @__PURE__ */ React.createElement("div", { className: "cs-body", style: { marginBottom: 48 } }, /* @__PURE__ */ React.createElement("div", { className: "lhs" }, "Workflow change"), /* @__PURE__ */ React.createElement("div", { className: "rhs" }, /* @__PURE__ */ React.createElement(WorkflowComparison, { workflow: data.workflow }))), Schema && data.schemaAnnotations && /* @__PURE__ */ React.createElement("div", { className: "cs-body" }, /* @__PURE__ */ React.createElement("div", { className: "lhs" }, "System diagram"), /* @__PURE__ */ React.createElement("div", { className: "rhs" }, /* @__PURE__ */ React.createElement(SchemaFigure, { Schema, annotations: data.schemaAnnotations }))))), !data.confidential && /* @__PURE__ */ React.createElement("section", { className: "cs-section" }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("h2", null, "Key screens"), /* @__PURE__ */ React.createElement("div", { className: "cs-screens" }, data.keyScreens.map(
    (s, i) => /* @__PURE__ */ React.createElement(
      "div",
      {
        className: "screen" + (s.image ? " screen--photo screen--clickable" : ""),
        key: i,
        onClick: s.image ? () => openLightbox(s) : void 0
      },
      /* @__PURE__ */ React.createElement("div", { className: "body" }, s.image ? /* @__PURE__ */ React.createElement("img", { src: s.image, alt: s.label }) : /* @__PURE__ */ React.createElement(Schema, null)),
      /* @__PURE__ */ React.createElement("div", { className: "label" }, s.label)
    )
  )), /* @__PURE__ */ React.createElement("div", { className: "cs-body", style: { marginTop: 32 } }, /* @__PURE__ */ React.createElement("div", { className: "lhs" }, "Detail"), /* @__PURE__ */ React.createElement("div", { className: "rhs" }, data.keyScreens.map(
    (s, i) => /* @__PURE__ */ React.createElement("p", { key: i }, /* @__PURE__ */ React.createElement("strong", null, s.label, "."), " ", s.desc)
  ))))), /* @__PURE__ */ React.createElement("section", { className: "cs-section" }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("h2", null, data.processLabel || "Process"), /* @__PURE__ */ React.createElement("div", { className: "cs-process" }, data.process.map(
    (p, i) => /* @__PURE__ */ React.createElement("div", { className: "item", key: i }, /* @__PURE__ */ React.createElement("div", { className: "num" }, p.n), /* @__PURE__ */ React.createElement("div", { className: "heading" }, p.heading), /* @__PURE__ */ React.createElement("div", { className: "body" }, p.body.split("\n\n").map((para, j) => /* @__PURE__ */ React.createElement("p", { key: j }, para))), p.image && /* @__PURE__ */ React.createElement("img", { src: p.image, alt: p.heading, className: "cs-process-img" }), p.images && /* @__PURE__ */ React.createElement("div", { className: "cs-process-imgs" }, p.images.map((src, idx) => /* @__PURE__ */ React.createElement(
      "img",
      {
        key: idx,
        src,
    ...
    ))), p.video && /* @__PURE__ */ React.createElement("video", { className: "cs-process-video", controls: true, playsInline: true, preload: "metadata" }, /* @__PURE__ */ React.createElement("source", { src: p.video })), p.callout && /* @__PURE__ */ React.createElement("div", { className: "cs-process-callout" }, p.callout))
  )))), data.testimonials && data.testimonials.length > 0 && /* @__PURE__ */ React.createElement("section", { className: "cs-section", style: { paddingTop: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("div", { className: "cs-body" }, /* @__PURE__ */ React.createElement("div", { className: "lhs" }, "What users said"), /* @__PURE__ */ React.createElement("div", { className: "rhs" }, data.testimonials.map(
    (t, i) => /* @__PURE__ */ React.createElement("blockquote", { key: i, className: "cs-testimonial" }, /* @__PURE__ */ React.createElement("p", null, '"', t.text, '"'), /* @__PURE__ */ React.createElement("cite", null, t.cite))
  ))))), /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("div", { className: "cs-quote" }, /* @__PURE__ */ React.createElement("blockquote", null, data.quote.text, /* @__PURE__ */ React.createElement("cite", null, data.quote.cite)))), data.takeaways && /* @__PURE__ */ React.createElement("section", { className: "cs-section" }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("h2", null, data.takeaways.heading), /* @__PURE__ */ React.createElement("div", { className: "cs-body" }, /* @__PURE__ */ React.createElement("div", { className: "lhs" }, "Takeaways"), /* @__PURE__ */ React.createElement("div", { className: "rhs" }, data.takeaways.body.map((p, i) => /* @__PURE__ */ React.createElement("p", { key: i }, p)))))), lightboxIndex !== null && /* @__PURE__ */ React.createElement(
    Lightbox,
    {
      screens: lbScreens,
      index: lightboxIndex,
  ...
  ), processLb !== null && /* @__PURE__ */ React.createElement(
    Lightbox,
    {
  ...
  ), /* @__PURE__ */ React.createElement("section", { className: "cs-next" }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("div", { className: "label" }, "Next project"), /* @__PURE__ */ React.createElement("a", { href: `case-study.html?slug=${data.next.slug}` }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "title" }, data.next.title), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--mono)", fontSize: 11, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--ink-3)", marginTop: 12 } }, data.next.tags)), /* @__PURE__ */ React.createElement("span", { className: "arrow" }, "View \u2192")))), /* @__PURE__ */ React.createElement("section", { className: "closer" }, /* @__PURE__ */ React.createElement("h2", null, "Let's work", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("em", null, "together"), "."), /* @__PURE__ */ React.createElement("div", { className: "right" }, /* @__PURE__ */ React.createElement("a", { className: "primary", href: "contact.html" }, "Start a conversation \u2192"), /* @__PURE__ */ React.createElement("a", { href: "https://www.linkedin.com/in/daniel-gruskin-4a514965/", target: "_blank" }, "Dan LinkedIn \u2197"))));
}
const root = ReactDOM.createRoot(document.getElementById("app"));
root.render(/* @__PURE__ */ React.createElement(CaseStudy, null));
